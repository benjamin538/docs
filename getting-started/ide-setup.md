...
The setup is very similar to [VS Code on Mac](#vs-code-on-mac), so you can follow that. The primary difference is you have to manually create a kit, which can be done like so:
